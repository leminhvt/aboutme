...
<div class="row">
	<div class="col-md-12 panel-info">
		<div class="content-box-header panel-heading">
			<div class="panel-title ">Thêm dự án</div>
		</div>
		<div class="content-box-large box-with-header">
			<form action="${pageContext.request.contextPath}/admin/project/add"
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label for="tenduan">Tên dự án</label> <input type="text"
									...
									name="tenduan">
								<form:errors path="project.tenduan"></form:errors>

							</div>
							<div class="form-group">
								<label for="link">Link</label> <input type="text"
									class="form-control" placeholder="" name="link">
								<form:errors path="project.link"></form:errors>
